...
var homeDirectives = angular.module('articlesDirectives', []);

homeDirectives.directive("homeRightMenu", ['articlesService', function (articlesService) {
    return {
        restrict: "E",
        replace: true,
        scope: {
...
homeDirectives.directive("homeLeftMenu", ['articlesService', 'utilityService', '$location', function (articlesService, utilityService, $location) {
    return {
        restrict: "E",
        replace: true,
        scope: {
