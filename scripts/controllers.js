...
.controller('articlesController',function($scope, $window,$routeParams,$location,$filter, articlesService,utilityService){
...
.controller('analysisController',function($scope, $window,$routeParams,$location,$filter, articlesService,utilityService,$rootScope){
